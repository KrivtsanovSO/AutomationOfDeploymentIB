...
**ВАЖНО!** По непонятной причине нельзя создать базу в указанной группе. Пробовал разные способы, ничего не получалось. На данный момент есть такая особенность.
...
**ВАЖНО!** По какой-то причине объединение выполняется дольше, чем интерактивно в конфигураторе. Особенно это заметно для больших типовых конфигураций: объединение ЕРП 2.5.7 с подливаемой конфигурацией для 1С:ТОИР занимает порядка 30 минут.
